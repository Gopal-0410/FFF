...
class NetworkHelper {
  ...
  Future getApiData({
    ...
    if (response.statusCode == 200) {
      ...
      var app_updateAppDialogStatus = data['APP_SETTINGS']['app_updateAppDialogStatus'];
      var app_versionCode = data['APP_SETTINGS']['app_versionCode'];
      var app_redirectOtherAppStatus = data['APP_SETTINGS']['app_redirectOtherAppStatus'];
      var app_newPackageName = data['APP_SETTINGS']['app_newPackageName'];
      var app_dialogBeforeAdShow = data['APP_SETTINGS']['app_dialogBeforeAdShow'];
      ...
      var app_adPlatformSequence = data['APP_SETTINGS']['app_adPlatformSequence'];
      var app_alernateAdShow = data['APP_SETTINGS']['app_alernateAdShow'];
      var app_howShowAdInterstitial = data['APP_SETTINGS']['app_howShowAdInterstitial'];
      var app_adPlatformSequenceInterstitial = data['APP_SETTINGS']['app_adPlatformSequenceInterstitial'];
      var app_alernateAdShowInterstitial = data['APP_SETTINGS']['app_alernateAdShowInterstitial'];
      var app_howShowAdNative = data['APP_SETTINGS']['app_howShowAdNative'];
      var app_adPlatformSequenceNative = data['APP_SETTINGS']['app_adPlatformSequenceNative'];
      var app_alernateAdShowNative = data['APP_SETTINGS']['app_alernateAdShowNative'];
      var app_howShowAdBanner = data['APP_SETTINGS']['app_howShowAdBanner'];
      var app_adPlatformSequenceBanner = data['APP_SETTINGS']['app_adPlatformSequenceBanner'];
      var app_alernateAdShowBanner = data['APP_SETTINGS']['app_alernateAdShowBanner'];
      ...
      sharedPreferences.setString('app_privacyPolicyLink', app_privacyPolicyLink);
      sharedPreferences.setString('app_needInternet', app_needInternet);
      sharedPreferences.setString('app_updateAppDialogStatus', app_updateAppDialogStatus);
      sharedPreferences.setString('app_versionCode', app_versionCode);
      sharedPreferences.setString('app_redirectOtherAppStatus', app_redirectOtherAppStatus);
      sharedPreferences.setString('app_newPackageName', app_newPackageName);
      sharedPreferences.setString('app_dialogBeforeAdShow', app_dialogBeforeAdShow);
      ...
      sharedPreferences.setString('app_adPlatformSequence', app_adPlatformSequence);
      sharedPreferences.setString('app_alernateAdShow', app_alernateAdShow);
      sharedPreferences.setString('app_howShowAdInterstitial', app_howShowAdInterstitial);
      sharedPreferences.setString('app_adPlatformSequenceInterstitial', app_adPlatformSequenceInterstitial);
      sharedPreferences.setString('app_alernateAdShowInterstitial', app_alernateAdShowInterstitial);
      sharedPreferences.setString('app_howShowAdNative', app_howShowAdNative);
      sharedPreferences.setString('app_adPlatformSequenceNative', app_adPlatformSequenceNative);
      sharedPreferences.setString('app_alernateAdShowNative', app_alernateAdShowNative);
      sharedPreferences.setString('app_howShowAdBanner', app_howShowAdBanner);
      sharedPreferences.setString('app_adPlatformSequenceBanner', app_adPlatformSequenceBanner);
      sharedPreferences.setString('app_alernateAdShowBanner', app_alernateAdShowBanner);
      sharedPreferences.setString('app_mainClickCntSwAd', app_mainClickCntSwAd);
      sharedPreferences.setString('app_innerClickCntSwAd', app_innerClickCntSwAd);
